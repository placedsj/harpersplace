...
import { VideoCallProvider, useVideoCall } from '@/hooks/use-video-call';
...
function VideoCallManager({ children }: { children: React.ReactNode }) {
  const { isVideoOpen, setIsVideoOpen } = useVideoCall();
