    ...
    const handleLogEvent = async (values: LogFormValues) => {
        ...
        try {
            ...
            await addDoc(evidenceCollectionRef, {
                ...
                partiesInvolved: values.partiesInvolved ? sanitizeText(values.partiesInvolved) : '',
                yourResponse: values.yourResponse ? sanitizeText(values.yourResponse) : '',
...
export default function EvidenceLogPage() {
    return (
        <Suspense fallback={<div className="flex h-screen w-screen items-center justify-center"><Loader2 className="animate-spin" /></div>}>
